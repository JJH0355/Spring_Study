...
public class StoreWorkDAO {
	...
	final String INSERT = "INSERT INTO BB_STORE_WORK(STORE_NUM, STORE_WORK_WEEK, STORE_WORK_OPEN, STORE_WORK_CLOSE) " +
	...
	final String selectAll = "SELECT STORE_WORK_WEEK, "
			+ "DATE_FORMAT(STORE_WORK_OPEN, '%H:%i') AS STORE_OPEN, "
			+ "DATE_FORMAT(STORE_WORK_CLOSE, '%H:%i') AS STORE_CLOSED "
