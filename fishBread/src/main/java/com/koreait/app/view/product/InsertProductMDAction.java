package com.koreait.app.view.product;
...
import com.koreait.app.biz.image.ImageDAO;
import com.koreait.app.biz.image.ImageDTO;
import com.koreait.app.biz.product.ProductCateDAO;
import com.koreait.app.biz.product.ProductCateDTO;
import com.koreait.app.biz.product.ProductDAO;
import com.koreait.app.biz.product.ProductDTO;

import comm.koreait.app.view.common.AsyncUtils;
import comm.koreait.app.view.common.AuthorizationUtils;
import comm.koreait.app.view.common.ConfigUtils;
...
public class InsertProductMDAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	//doAction(session, request, response, productCateDTO, productDTO, boardDTO, imageDTO);
    }
    
    
    protected void doAction(HttpSession session, HttpServletRequest request, HttpServletResponse response, ProductCateDTO productCateDTO, ProductDTO productDTO, BoardDTO boardDTO, BoardDTO boardMaxPK, ImageDTO imageDTO) throws ServletException, IOException {
