...
<head>
  ...
  <link rel="icon" href="../resources\assets\images\logo.png" type="image/x-icon" />
      ...
      <div class="container">
        <div class="page-inner"> <!-- 페이지 내부 -->
          <div class="page-header">
            <h3 class="fw-bold mb-3">가게 등록</h3> <!-- 페이지 제목 -->
            <ul class="breadcrumbs mb-3"><!-- 관리자 페이지 내의 페이지 경로 -->
              <!-- 첫 번째 경로 -->
              <li class="nav-home"><!-- 홈 링크 -->
                <a href="#">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <section>
                    <h3><b>가게 이름</b></h3>
                    <div><input type="text" required placeholder="가게 이름을 입력해주세요."></input></div>
                  </section>
                  <br><br>
                  ...
                  <section>
                    <h3><b>전화번호(선택)</b></h3>
                    <div><input type="tel" required placeholder="전화번호를 입력해주세요."></input>
                    </div>
                  </section>
                  <br><br>
                  ...
                  <section>
                    <!--1행 주소검색 -->
                    <div class="container-fluid d-flex justify-content-between"> <!-- 컨테이너로 좌우 정렬 -->
                      <h3 class="pull-left"><b>주소 입력</b>
                      </h3>
                      <div class="copyright">
                      </div>
                      <div> 
                        <button type="button" class="btn btn-black" id="">주소 검색</button>
                      </div></div>
                      <!--2행 주소검색데이터 불러오기-->
                    <div><input type="text" required placeholder="주소검색버튼을 눌러주세요."></input>
                      <br><br>
                      <input type="text" required placeholder="우편번호 입력"></input>
                      <br><br>
                      <input type="text" required placeholder="상세주소 입력"></input>
                    </div>
                  </section>
                  <br><br>
                  ...
                  <div style="text-align: right;">
                    <button type="button" class="btn btn-primary" id="">등록하기</button>
                  </div>
                </div><!--카드 내용 부분 끝-->
              </div>
            </div>
